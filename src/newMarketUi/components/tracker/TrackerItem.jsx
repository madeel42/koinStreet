...
import { CHANGELLY_REF_ID, SYMBOL_EMPTY } from './../../constants';
...
class TrackerItem extends Component {
  shouldComponentUpdate(nextProps) {
    ...
    return (
      ...
      parseFloat(item.priceUsd, 10) !==
        parseFloat(nextProps.item.priceUsd, 10) ||
    ...
    return (
      ...
      >
        ...
        <div className='app-table-col text-right'>
          ...
          {isNumber(item.volumeUsd24Hr) ? (
            <FormattedNumber value={item.volumeUsd24Hr} />
          ) : (
            SYMBOL_EMPTY
          )}
        </div>
        <div className='app-table-col text-right'>
          ...
          {isNumber(item.maxSupply) ? (
            <FormattedNumber value={item.maxSupply} />
          ) : (
            SYMBOL_EMPTY
          )}
        </div>
